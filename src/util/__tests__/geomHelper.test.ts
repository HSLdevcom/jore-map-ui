...
describe('geomHelper.createCoherentLinesFromPolylines', () => {
    it('Concatenates 1 line into 1 line', () => {
        ...
        expect(GeomHelper.createCoherentLinesFromPolylines([line])).toEqual(expectedResult);
    });
    ...
    it('Concatenates 2 lines into 1 line', () => {
        ...
        expect(GeomHelper.createCoherentLinesFromPolylines([line1, line2])).toEqual(expectedResult);
    });
    ...
    it('Concatenates multiple lines into 2 lines', () => {
        ...
        expect(
            GeomHelper.createCoherentLinesFromPolylines([line1, line2, line3, line4, line5])
