        ...
        <div className={s.confirmView} data-cy="confirmView">
            ...
            {
              {
                ...
                removeRoutePathConfirm: <RemoveRoutePathConfirm {...(confirmData as any)} />,
          ...
          <div className={s.buttonWrapper}>
            {confirmStore!.confirmNotification && (
              <div className={s.confirmNotification}>{confirmStore!.confirmNotification}</div>
            )}
            <div className={s.buttons}>
              ...
              <Button
                ...
                type={ButtonType.SQUARE}
                onClick={
                  shouldShowDoubleConfirm ? displayDoubleConfirm : confirmStore!.confirm
                }
                isWide={true}
