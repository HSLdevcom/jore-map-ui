...
const NodeLayer = inject(
  ...
  observer((props: INodeLayerProps) => {
    ...
    if (props.mapStore!.zoom > 15) {
      const nodeAreasMap: Map<LatLngBounds, ISearchNode[]> = _getNodeAreasMap(nodesInMapBounds)
...
const _getNodeAreasMap = (
  nodesInMapBounds: ISearchNode[]
): Map<LatLngBounds, ISearchNode[]> => {
