      ...
      <>
        {(this.props.networkStore!.isMapLayerVisible(MapLayer.link) ||
          ...
          <VectorGridLayer
            ...
            setVectorgridLayerReaction={this.setVectorgridLayerReaction(TileserverLayer.Link)}
        ...
        {this.props.networkStore!.isMapLayerVisible(MapLayer.linkPoint) && (
          <VectorGridLayer
            ...
            setVectorgridLayerReaction={this.setVectorgridLayerReaction(TileserverLayer.Point)}
