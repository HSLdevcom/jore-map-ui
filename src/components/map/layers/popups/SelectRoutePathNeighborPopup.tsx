          ...
          (selectNeighborProps: ISelectRoutePathNeighborProps, index: number) => {
            ...
            return (
              <div
                ...
                className={s.row}
                onMouseOver={() =>
                  highlightLink(selectNeighborProps.neighborLink.routePathLink, true)
                }
                onMouseOut={() =>
                  highlightLink(selectNeighborProps.neighborLink.routePathLink, false)
                }
                onClick={() =>
                  selectRoutePathNeighbor(selectNeighborProps.neighborLink, props.popupId)
                }
                data-cy="node"
                ref={containerRef}
              >
