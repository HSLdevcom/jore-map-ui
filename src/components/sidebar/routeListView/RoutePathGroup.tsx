        ...
        <div className={s.routePathContainer}>
          {routePaths.map((routePath: IRoutePath) => {
            ...
            const rpCopiedFromText =
              isNew && oldRoutePath
                ? `Kopioitu reitinsuunta: ${oldRoutePath.direction} | ${toDateString(
                    oldRoutePath.startDate
                  )} - ${toDateString(oldRoutePath.endDate)} | ${oldRoutePath.originFi} - ${
                    oldRoutePath.destinationFi
                  } | ${oldRoutePath.lineId} | ${oldRoutePath.routeId}`
                : ''
            return (
              <div
                className={classnames(
              ...
              >
                <div
                  className={classnames(
                    isEditingAllowed ? s.routePathInfoEditing : s.routePathInfoNotEditing,
                    shouldHighlightRoutePath ? s.routePathHighlighted : undefined
                  )}
                  onClick={isEditingAllowed ? void 0 : this.openRoutePathView(routePath)}
                  title={
                    isNew && oldRoutePath
                      ? rpCopiedFromText
                      : isEditingAllowed
                  ...
                  <div className={s.routePathContainer}>
                    ...
                    <div>
                      {isLoading ? (
                        ...
                        <>
                          <div className={s.destinations1}>{destinations1}</div>
                          <div className={s.destinations2}>{destinations2}</div>
                        </>
                      )}
                    </div>
                  </div>
                ...
                <div className={s.routePathControls}>
                  {isEditingAllowed && isNew && (
                    <>
                      <Button
                        ...
                        title={'Eriytä kopioitu reitinsuunta omaan kalenteriryhmään'}
                  ...
                  {!isEditing && (
                    <Button
                      ...
                      onClick={() => this.props.selectRoutePathToBeCompared(routePath)}
