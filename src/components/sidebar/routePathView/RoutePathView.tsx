          ...
          <>
            {routePathStore!.isCompareRoutePathsContainerVisible ? (
              <>
                <Button
                  isWide={true}
                  hasNoMargin={true}
                  onClick={() => routePathStore!.setIsCompareRoutePathsContainerVisible(false)}
                >
            ...
            routePathStore!.isCompareRoutePathsContainerVisible ? (
              <SaveButton
                ...
                type={savePreventedNotification.length > 0 ? 'warningButton' : 'saveButton'}
              ...
              <Button
                ...
                onDisabledButtonClick={
                  !isEmpty(savePreventedNotification)
                    ? () => this.showClickPreventedNotification(savePreventedNotification)
                    : undefined
                }
                hasPadding={true}
