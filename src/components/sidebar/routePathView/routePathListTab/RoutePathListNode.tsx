...
const RoutePathListNode = inject(
  ...
  observer(
    React.forwardRef(
      (props: IRoutePathListNodeProps, ref: React.RefObject<HTMLDivElement>) => {
        ...
        const renderHeader = () => {
          ...
          const isNodeDisabled =
            routePathLink.startNodeType === StartNodeType.DISABLED && !isLastNode
          const isStop = node.type === NodeType.STOP
          return (
            <div className={classnames(s.itemHeader, isNodeDisabled ? s.opacity : undefined)}>
              <div
              ...
              >
                ...
                <div
                  className={classnames(
                    s.hastusId,
                    isLastNode || isNodeDisabled || routePathLink.isStartNodeHastusStop
                      ? undefined
                      : s.opacity
                  )}
                >
                ...
                <div className={s.viaWrapper}>
                  {!isLastNode && (
                    <>
                      ...
                      <div className={s.via}>
                        {routePathLink.destinationFi2 ? routePathLink.destinationFi2 : ''}
                      </div>
                    </>
                  )}
                </div>
            ...
            <div>
                ...
                <>
                  ...
                  <div className={s.flexRow}>
                    <Dropdown
                      ...
                      onChange={onRoutePathLinkPropertyChange('startNodeTimeAlignmentStop')}
                      disabled={isEditingDisabled}
                      selected={routePathLink.startNodeTimeAlignmentStop}
                      items={props.codeListStore!.getDropdownItemList('Ajantasaus pysakki')}
                    />
                    <Dropdown
                      label="ERIKOISTYYPPI"
                      ...
                      items={props.codeListStore!.getDropdownItemList('Pysäkin käyttö')}
                    />
                  </div>
                  <div className={s.flexRow}>
                    <InputContainer
              ...
              <div className={s.flexRow}>
                <Checkbox
                  ...
                  onClick={onIsStartNodeUsingBookScheduleChange(!isStartNodeUsingBookSchedule)}
                />
              </div>
              <div className={s.flexRow}>
                <InputContainer
