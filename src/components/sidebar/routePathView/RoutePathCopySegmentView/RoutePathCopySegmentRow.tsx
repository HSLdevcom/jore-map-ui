  ...
  observer((props: IRoutePathCopySegmentRowProps) => {
    ...
    return (
      <div className={s.routePathRow}>
        <div onClick={expandRow} className={s.routePathRowHeader} data-cy="rpSegmentRowHeader">
        ...
        {isExpanded &&
          (isLoading ? (
            ...
            <div>
              {routePathSegments.map((rpSegment: IRoutePathSegment, index: number) => {
                ...
                return (
                  <div
                    ...
                    className={classnames(
                      ...
                      shouldHighlightRpSegment ? s.rpSegmentHighlighted : undefined
                    )}
                  ...
                  >
                    <div>
                      <div>
                        {rpSegment.routeId} {rpSegment.originFi} - {rpSegment.destinationFi}
                      </div>
                      <div className={s.timestampRow}>
                        {Moment(rpSegment.startDate).format('DD.MM.YYYY')} -{' '}
