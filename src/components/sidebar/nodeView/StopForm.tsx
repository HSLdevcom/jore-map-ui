...
class StopForm extends Component<IStopFormProps, IStopFormState> {
  ...
  private redirectToNewStopArea = () => {
    ...
    if (this.props.isNewStop) {
      ...
      link = RouteBuilder.to(SubSites.newStopArea).append(QueryParams.nodeId, node.id).toLink()
    }
      ...
      <div className={classnames(s.stopView, s.form)}>
        ...
        <div className={s.formSection}>
          ...
          <div className={s.messageContainer}>
            Jos osoitetiedot eivät päivity automaattisesti, voit hakea oikeat tiedot esim.
            täältä:{' '}
