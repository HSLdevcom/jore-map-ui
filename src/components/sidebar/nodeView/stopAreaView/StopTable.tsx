        ...
        <div className={s.flexRow}>
          {stopItems.length > 0 ? (
            <table className={s.stopHeaderTable}>
              <tbody>
                <tr>
                  <th className={classnames(s.inputLabel, s.columnHeader)}>SOLMUN TUNNUS</th>
                  <th className={classnames(s.inputLabel, s.columnHeader)}>NIMI SUOMEKSI</th>
                  <th className={classnames(s.inputLabel, s.columnHeader)}>NIMI RUOTSIKSI</th>
