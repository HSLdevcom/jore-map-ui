...
class StopAreaView extends React.Component<IStopAreaViewProps, IStopAreaViewState> {
  ...
  render() {
    ...
    const isSaveButtonDisabled =
      !transitType || isEditingDisabled || !stopAreaStore.isDirty || !stopAreaStore.isFormValid
            ...
            <div className={s.formSection}>
              ...
              <div className={s.flexRow}>
                <Dropdown
                  ...
                  items={this.props.codeListStore!.getDropdownItemList('Pysäkkialueid')}
