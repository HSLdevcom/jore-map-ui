          ...
          {node.type === NodeType.STOP && (
            <div className={s.flexRow}>
              <Dropdown
                ...
                onChange={
                  onChangeNodeProperty ? onChangeNodeProperty('shortIdLetter') : undefined
                }
          ...
          {node.type === NodeType.STOP && (
            <>
              <CoordinateInputRow
                ...
                onChange={
                  onChangeNodeGeometry ? onChangeNodeGeometry('coordinates') : () => void 0
                }
              />
              <div className={s.flexRow}>
                <InputContainer
                  ...
                  disabled={isEditingDisabled}
                  onChange={
                    onChangeNodeProperty ? onChangeNodeProperty('measurementDate') : undefined
                  }
                ...
                <Dropdown
                  ...
                  onChange={
                    onChangeNodeProperty ? onChangeNodeProperty('measurementType') : undefined
                  }
