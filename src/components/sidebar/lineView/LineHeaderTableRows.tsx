          ...
          >
            <td className={s.lineHeaderTableNameCell}>
              <InputContainer
                ...
                validationResult={{
                  ...
                  errorMessage: isLineHeaderValid ? '' : 'Sisältää validaatiovirheitä',
                }}
              />
            </td>
            <td
            ...
            >
              <InputContainer
                ...
                onChange={this.onChangeLineHeaderStartDate(currentMassEditLineHeader.id)}
            ...
            >
              <InputContainer
                ...
                onChange={this.onChangeLineHeaderEndDate(currentMassEditLineHeader.id)}
              />
            </td>
              ...
              {this.props.loginStore!.hasWriteAccess && (
                <Button
                  className={classnames(
                    ...
                    isRemoveLineHeaderButtonDisabled ? s.disabledLineHeaderButton : undefined,
            ...
            <td className={s.lineHeaderTableButtonCell}>
              {this.props.loginStore!.hasWriteAccess && (
                <Button
                  ...
                  hasReverseColor={true}
                  onClick={this.createNewLineHeaderWithCopy(currentMassEditLineHeader.id)}
                  disabled={isEditingDisabled}
                  hasNoTransition={true}
                >
                  <FiCopy />
