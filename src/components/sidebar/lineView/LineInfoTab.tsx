        ...
        <div className={s.form}>
          ...
          <div className={s.flexRow}>
            <Dropdown
              ...
              items={this.props.codeListStore!.getDropdownItemList('Joukkoliikennelaji')}
            ...
            <Dropdown
              ...
              items={this.props.codeListStore!.getDropdownItemList('Tilaajaorganisaatio')}
          ...
          <div className={s.flexRow}>
            <Dropdown
              ...
              items={this.props.codeListStore!.getDropdownItemList('Joukkoliikennekohde')}
            ...
            <Dropdown
              ...
              items={this.props.codeListStore!.getDropdownItemList('LinjanKorvaavaTyyppi')}
