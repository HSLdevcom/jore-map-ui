    ...
    return (
      <div className={s.lineHeaderTableView} data-cy="lineHeaderTableView">
        ...
        <div className={s.flexRow}>
          <TextContainer
            className={!Boolean(activeLineHeaderName) ? s.lineHeaderNameNotActive : undefined}
            label={'LINJAN VOIMASSAOLEVA OTSIKKO'}
            value={
              activeLineHeaderName ? activeLineHeaderName : 'Ei voimassa olevaa otsikkoa.'
            }
        ...
        {this.props.loginStore!.hasWriteAccess && (
          <div className={s.lineHeaderButtonContainer}>
            ...
            <Button
              isWide={true}
              onClick={() => this.setIsSearchLineHeadersCopyViewOpen({ isOpen: true })}
